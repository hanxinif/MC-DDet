...
from .Focal_EIoUloss_2_using import focaleiou_iouloss
from .losses import IOUloss
from .network_blocks import BaseConv, DWConv
from .gfr import GFR
from .attention import EffectiveSELayer
from .Focalloss import FocalLoss


class EDHead(nn.Module):
    def __init__(
        self,
        num_classes,
        width=1.0,
        ...
        self.use_l1 = False
        self.l1_loss = nn.SmoothL1Loss(reduction="none", beta=4)
        self.obj_loss = FocalLoss(reduction="none")
        self.cls_loss = nn.BCEWithLogitsLoss(reduction="none")
        self.iou_loss = focaleiou_iouloss(reduction="none")
