...
import sys
sys.path.append("/home/onepiece/programs/DFeS-DNet")
import cv2
...
def make_parser():
    ...
    parser.add_argument(
        "--path", default=os.path.join(ROOT, "demo_files"), help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default=os.path.join(ROOT, "exps/neu_det/neu-det.py"),
        type=str,
        help="please input your experiment description file",
    )
    parser.add_argument("-c", "--ckpt", default=os.path.join(ROOT, "weigth/neu-det-weigth.pth"),
